    ...
    <footer class="navbar">
        ...
        <div class="button-container">
            <button @click="goTo('home')" class="navbar-button" :class="{ 'active': activeButton === 'home' }" style="margin-left: 20px;">
                <img :src="activeButton === 'home' ? '/assets/home-active.svg' : '/assets/home.svg'" alt="Home Icon" class="navbar-icon" />
            ...
            <button @click="goTo('activity')" class="navbar-button" :class="{ 'active': activeButton === 'activity' }">
                <img :src="activeButton === 'activity' ? '/assets/activity-active.svg' : '/assets/activity.svg'" alt="activity Icon" class="navbar-icon" />
            ...
            <button @click="goTo('wallet')" class="navbar-button" :class="{ 'active': activeButton === 'wallet' }">
                <img :src="activeButton === 'wallet' ? '/assets/wallet-active.svg' : '/assets/wallet.svg'" alt="wallet Icon" class="navbar-icon" />
            ...
            <button @click="goTo('account')" class="navbar-button" :class="{ 'active': activeButton === 'account' }" style="margin-right: 20px;">
                <img :src="activeButton === 'account' ? '/assets/account-active.svg' : '/assets/account.svg'" alt="account Icon" class="navbar-icon" />
